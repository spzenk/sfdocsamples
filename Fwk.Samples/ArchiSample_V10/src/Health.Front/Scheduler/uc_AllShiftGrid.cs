...
namespace Health.Front.Scheduler
{
    ...
    public partial class uc_AllShiftGrid : Xtra_UC_Base
    {
        ...
        public override void Refresh()
        {
            if (profesional != null)
            {
                this.appointmentListBindingSource.DataSource = Controller.RetriveAppointment(null, this.Date, profesional.IdProfesional,Controller.CurrentHealthInstitution.HealthInstitutionId);
            ...
            else
            {
                ...
                this.appointmentListBindingSource.DataSource = Controller.RetriveAppointment(null, this.Date);
            }
        ...
        private void gridView2_DoubleClick(object sender, EventArgs e)
        {
            ...
            using (frmShiftAppointment frm = new frmShiftAppointment())
            {
                ...
                if (this.profesional == null)
                {
                    ...
                    this.profesional = Controller.GetProfesional(SelectedAppointment.ResourceId, false, false,false).BusinessData.profesional;
