...
namespace Health.Front.Personas
{
    public partial class uc_MedioContacto : UserControl
    {
        ...
        internal void Init()
        {
            ...
            int index = 0;
            cmbPaices.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Paices, null);//Todos los paices

            if (!Persona.CountryId.HasValue && !Persona.ProvinceId.HasValue && !Persona.CityId.HasValue)
            {
                cmbPaices.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Paices, null);//Todos los paices
                cmbPaices.ItemIndex = 0;
                cmbProvincia.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Provincia, 1051);//Provincias de Arg 
                cmbProvincia.ItemIndex = 0;
                cmbLocalidad.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Localidad, 1106);//Localidades de Cordoba
            ...
            else
            {
                ...
                {
                    cmbProvincia.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Provincia, Persona.CountryId);//Provincias de usuario
                ...
                {
                    cmbLocalidad.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Localidad, Persona.CountryId);//Localidad del usuario
        ...
        private void cmbPaices_EditValueChanged(object sender, EventArgs e)
        {
            ...
            cmbProvincia.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Provincia, Convert.ToInt32(cmbPaices.EditValue));//Provincias de Arg 
            cmbProvincia.ItemIndex = 0;
            cmbProvincia.Refresh();
            cmbLocalidad.Properties.DataSource = Controller.SearchParametroByParams((int)TipoParametroEnum.Localidad, Convert.ToInt32(cmbProvincia.EditValue));//Localidades de Cordoba
            cmbLocalidad.ItemIndex = 0;
            cmbLocalidad.Refresh();
        }
