...
{
    public partial class MicrosoftCombocontrol : System.Web.UI.UserControl
    {
        ...
        internal void Populate(List<String> pComboValues)
        {
            ...
            this.UpdatePanel2.ID = string.Concat("UpdatePanel_", _Item.ItemQuestionId);
        ...
        void cmbTest_SelectedIndexChanged(object sender, EventArgs e)
        {
