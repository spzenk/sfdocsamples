<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="main_menu_2.ascx.cs"
    Inherits="ShoppingCart.main_menu_2" %>
...
<div>
    <ul id="menu">
        <li><a class="menuv_a" href="/Default.aspx">Inicio</a> </li>
