<%@ Page Title="" Language="C#" MasterPageFile="~/AnimationExtender.master" AutoEventWireup="true" CodeBehind="AnimationExtender_Click.aspx.cs" Inherits="AjaxControlToolkitSample.Modules.AnimationExtender_Click" %>
                ...
                <OnClick>
                    <Sequence>
                        ...
                        <Parallel  AnimationTarget="moveMe" Duration=".5" Fps="30">
                            <Move Horizontal="150" Vertical="150"></Move>
