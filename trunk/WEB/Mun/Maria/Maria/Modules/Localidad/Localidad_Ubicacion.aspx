<%@ Page Title="" Language="C#" MasterPageFile="~/Maria_Localidad.master" AutoEventWireup="true" CodeBehind="Localidad_Ubicacion.aspx.cs" Inherits="Maria.Modules.Localidad.Localidad_Ubicacion" %>
...
<div id="d1" class ="EnvelopeNews">
    ...
    <p>
        La localidad de Adelia María se encuentra ubicada geográficamente al S.E del Departamento
        Río Cuarto.<br style="margin-left: 40px" />
        Dista 90 Km. de la ciudad de Río Cuarto y 325 Km. de la capital de la Provincia.
        ...
        <br style="margin-left: 40px" />
        <br style="margin-left: 40px" />
        Demográficamente ha crecido a un ritmo sostenido. Según Información el censo de
        2001 arrojo 6.379 habitantes.
        <br style="margin-left: 40px" />
