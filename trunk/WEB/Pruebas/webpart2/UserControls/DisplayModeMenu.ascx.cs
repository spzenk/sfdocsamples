...
public partial class UserControls_DisplayModeMenu : System.Web.UI.UserControl
{
    ...
    public void DisplayModeDropdown_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void RadioButton2_CheckedChanged(object sender,
      EventArgs e)
    {
        if (_manager.Personalization.CanEnterSharedScope && _manager.Personalization.Scope == PersonalizationScope.User)
            _manager.Personalization.ToggleScope();
    }
}
