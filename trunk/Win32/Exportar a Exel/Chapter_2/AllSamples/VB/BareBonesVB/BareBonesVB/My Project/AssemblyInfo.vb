...
<Assembly: AssemblyTitle("BareBonesVB")> 
<Assembly: AssemblyDescription("")> 
<Assembly: AssemblyCompany("Indigo Books & Music Inc.")> 
<Assembly: AssemblyProduct("BareBonesVB")> 
<Assembly: AssemblyCopyright("Copyright © Indigo Books & Music Inc. 2005")> 
<Assembly: AssemblyTrademark("")> 

<Assembly: ComVisible(False)>

'The following GUID is for the ID of the typelib if this project is exposed to COM
<Assembly: Guid("f6dc4b66-f6d5-4b06-b89e-574430867bd0")> 
