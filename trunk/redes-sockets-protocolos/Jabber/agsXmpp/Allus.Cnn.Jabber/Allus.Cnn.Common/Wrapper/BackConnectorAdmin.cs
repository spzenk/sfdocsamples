...
namespace Allus.Cnn.Common
{
    ...
    public class BackConnectorAdmin
    {
        #region fields

        System.Timers.Timer _Timer;
        public event ConnectorWrapperHandler Event;
        private AdminWrapper _Wrapper = null;
        private Allus.Cnn.Common.BE.Colaborator _CurrentColaborator = null;
        #endregion

        public BackConnectorAdmin(AdminWrapper wrapper, Allus.Cnn.Common.BE.Colaborator currentColaborator)
        {
            _Wrapper = wrapper;
