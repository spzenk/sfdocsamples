...
namespace Health.Svc
{
    ...
    /// <summary>
    /// Obtine el profecional por IdProfesional o UserGuid
    ...
    /// Opcionalmente se pueden retornar una lista de todas las relaciones del profecional con otras instituciones
    /// </summary>
    public class GetProfesionalService : BusinessService<GetProfesionalReq, GetProfesionalRes>
    {
        public override GetProfesionalRes Execute(GetProfesionalReq pServiceRequest)
        {
            ...
            if (pServiceRequest.BusinessData.IncludeSecurityInfo)
            {
                ...
                ///Si != nul indica q se trata de un usuario profecional relacionado a una instoitución
