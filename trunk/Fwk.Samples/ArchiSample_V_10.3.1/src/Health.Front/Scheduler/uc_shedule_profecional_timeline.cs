...
{
    [ToolboxItem(true)]
    public partial class uc_shedule_profecional_timeline : Xtra_UC_Base
    {
        #region
        ...
        internal uc_shedule_profecional_timeline()
        {
            InitializeComponent();
        ...
        void Update_ShiftsControls()
        {
            ...
            RetriveResourceSchedulingAndAppoinmentsRes res = Controller.RetriveResourceSchedulingAndAppoinments(SelectedProfesionalBE.IdProfesional, CurrentDateTime,false,Controller.CurrentHealthInstitution.HealthInstitutionId);
