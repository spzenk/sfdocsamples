...
namespace EjecutarTemplateRuntime
{
    public partial class Form1 : Form
    {
        string templateFileName = @"D:\Projects\DocEjemplos\SF\T4\Pruebas\LlamarMetodosDeOtraClase\LlamarMetodosDeOtraClase\EmptyTemplate1.tt";
        public Form1()
        {
            InitializeComponent();
        }
