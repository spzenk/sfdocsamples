...
namespace Health.Front
{
    ...
    /// <summary>
    /// Clase q presenta la interfaz de llamadas a los servicios de backEnd del sistema Healt
    /// Adicionalmente permite la carga asincrona de elementos reutilizables como lo son las clases Params
    /// </summary>
    public class ServiceCalls
    {
        ...
        public static PMOFileList PMOFileList { get { return ServiceCalls._PMOFileList; } }

        static Health.BE.PMOFileList _PMOFileList;

        static Health.BE.CEI10ComboList _CEI_10ComboList;

        public static CEI10GridList CEI_10List { get { return ServiceCalls._CEI_10List; } }
        public static CEI10ComboList CEI_10ComboList { get { return ServiceCalls._CEI_10ComboList; } }
        ...
        {
            get { return ServiceCalls._TipoEventoMedicoList; }
            set { ServiceCalls._TipoEventoMedicoList = value; }
        }
        ...
        {
            get { return ServiceCalls._AllergiesItemTypesList; }
            set { ServiceCalls._AllergiesItemTypesList = value; }
        }
        public static ParametroList EspecialidadMedicaList
        {
            get { return ServiceCalls._EspecialidadMedicaList; }
            set { ServiceCalls._EspecialidadMedicaList = value; }
        }
        public static ParametroList ProfecionesList
        {
            get { return ServiceCalls._ProfecionesList; }
            set { ServiceCalls._ProfecionesList = value; }
        }
        ...
        static void Populate(out Exception ex)
        {
            ...
            try
            {
                _ProfecionesList = SearchParametroByParams((int)TipoParametroEnum.Profesion, null);
                ...
                _AllergiesItemTypesList = ServiceCalls.SearchParametroByParams((int)TipoParametroEnum.AllergiesItemTypes, null);
        ...
        public static void DeleteParametro(int pIdParametro, string name)
        {
            ...
            req.ContextInformation.UserId = frmBase_TabForm.IndentityUserInfo.ProviderId.ToString();
            if (ServiceCalls.CurrentHealthInstitution != null)
