...
namespace Fwk.UI.Security.ServiceCalls
{
    public class SecurityServiceCalls
    {
        ...
        {
            get { return SecurityServiceCalls._AllRolList; }
            set { SecurityServiceCalls._AllRolList = value; }
        }
        ...
        {
            get { return SecurityServiceCalls._FwkAuthorizationRuleList; }
            set { SecurityServiceCalls._FwkAuthorizationRuleList = value; }
        }
        ...
        public static void UserApprove(string pUserName, bool pUserApprove)
        {
            try
            {
                //TODO: No usa servicios SecurityServiceCalls
                //if (pUserApprove)
