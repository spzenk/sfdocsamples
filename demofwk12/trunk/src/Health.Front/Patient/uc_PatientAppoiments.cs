    ...
    public partial class uc_PatientAppoiments : Xtra_UC_Base
    {
        ...
        private void gridView2_DoubleClick(object sender, EventArgs e)
        {
            ...
            using (frmShiftAppointment frm = new frmShiftAppointment())
            {
                ...
                frm.Profesional.Nombre = ServiceCalls.CurrentProfesional.Persona.Nombre;
                frm.Profesional.Apellido = ServiceCalls.CurrentProfesional.Persona.Apellido;
                frm.Profesional.IdEspecialidad = ServiceCalls.CurrentProfesional.IdEspecialidad;
                frm.Profesional.NombreEspecialidad = ServiceCalls.CurrentProfesional.NombreEspecialidad;
                frm.Profesional.IdProfesion = ServiceCalls.CurrentProfesional.IdProfesion;
        ...
        void UpdateStatus(AppoimantsStatus_SP status)
        {
            try
            {
                ...
                //}
                ServiceCalls.UpdateAppoimentStatus(appList);
