...
namespace Health.Front.profesional
{
    ...
    public partial class uc_Profesionales_Card : Xtra_UC_Base
    {
        ...
        void MachRolesGrid(string[] roles)
        {
            ...
            foreach (Rol lstRol in SecurityServiceCalls.AllRolList.Where(r => r.RolName.StartsWith("inst_")))
            {
        ...
        private void lstBoxRoles_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lblRolDescription.Text = SecurityServiceCalls.AllRolList.Where(r => r.RolName.Equals(rol)).FirstOrDefault().Description;
        }
        #endregion
        ...
        private void btnCheckUserName_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    btnCheckUserName.Image = global::Health.Front.Base.Properties.Resource.User_4_Check;
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnResetPwd_Click(object sender, EventArgs e)
        {
            ...
            if (r == DialogResult.Yes)
            {
                ...
                try
                {
                    SecurityServiceCalls.UserResetPassword(this.profesionalBE.UserName, txtUsername.Text);
                }
                catch (Exception ex)
                {
                    this.ExceptionViewer.Show(ex);
