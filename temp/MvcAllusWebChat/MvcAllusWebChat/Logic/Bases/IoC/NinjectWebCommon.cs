...
using WebChat.Logic.Bases.IoC;
//Evita agregar codigo a Global.asax para llamar a NinjectWebCommon
//El uso principal de esta función es permitir que las tareas que no se pueden hacer dentro de Application_Start porque es demasiado tarde. 
//Por ejemplo, el registro de proveedores de la construcción y la adición de referencias de ensamblado.(ninject mapings
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(WebChat.Common.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(WebChat.Common.NinjectWebCommon), "Stop")]
...
namespace WebChat.Common
{
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
           ...
           // kernel.Bind<ISecurityAdapter>().To<SecurityAdapter>();
            ...
            //kernel.Bind(typeof(ISecurityAdapter)).ToConstructor(ISecurityAdapter
            //     c =>
