...
namespace TcpClientApp
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void buttonConnect_Click(object sender, System.EventArgs e)
		{
            ...
            //tcp = new TcpClient((new IPEndPoint(Dns.Resolve(Dns.GetHostName()).AddressList[0], 9000)));
            tcp = new TcpClient((new IPEndPoint(Dns.GetHostEntry(Dns.GetHostName()).AddressList[0], 9000)));
            ...
            tcp.Connect(new IPEndPoint(Dns.GetHostEntry(ipAddress).AddressList[0], 9000));
