...
namespace OpenPopUnitTests.Mime
{
	...
	public class ToMailMessageTests
	{
		...
		public void ToMailMessageSimpleHasTextBodyWithCorrectEncodingISO88591()
		{
			...
			MailMessage mailMessage = new OPMessage(Encoding.GetEncoding("ISO-8859-1").GetBytes(message)).ToMailMessage();
		...
		public void ToMailMessageSimpleHasTextBodyWithCorrectEncodingISO88599()
		{
			...
			MailMessage mailMessage = new OPMessage(Encoding.GetEncoding("ISO-8859-9").GetBytes(message)).ToMailMessage();
		...
		public void ToMailMessageMultiPartMessage()
		{
			...
			MailMessage mailMessage = new OPMessage(Encoding.ASCII.GetBytes(multipartMessage)).ToMailMessage();
		...
		public void TestSenderNotIncluded()
		{
			...
			MailMessage message = new OPMessage(Encoding.ASCII.GetBytes(messageString)).ToMailMessage();
