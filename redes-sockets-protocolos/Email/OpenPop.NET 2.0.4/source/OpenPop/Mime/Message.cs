...
namespace OpenPop.Mime
{
	...
	/// <br/>
	/// Use the <see cref="OPMessage.MessagePart"/> property to find the actual content of the email message.
	/// </summary>
	/// <example>
	...
	public class OPMessage
	{
		...
		#region Constructors
		/// <summary>
		/// Convenience constructor for <see cref="Mime.OPMessage(byte[], bool)"/>.<br/>
		/// <br/>
		...
		public OPMessage(byte[] rawMessageContent)
		...
		/// </param>
		public OPMessage(byte[] rawMessageContent, bool parseBody)
		{
		...
		/// <summary>
		/// This method will convert this <see cref="OPMessage"/> into a <see cref="MailMessage"/> equivalent.<br/>
		...
		/// <summary>
		/// Finds the first <see cref="MessagePart"/> in the <see cref="OPMessage"/> hierarchy with the given MediaType.<br/>
		/// <br/>
		...
		/// <summary>
		/// Finds all the <see cref="MessagePart"/>s in the <see cref="OPMessage"/> hierarchy with the given MediaType.
		/// </summary>
		/// <param name="mediaType">The MediaType to search for. Case is ignored.</param>
		/// <returns>
		...
		/// a depth first traversal of the <see cref="OPMessage"/> hierarchy.
		/// </returns>
		...
		/// <summary>
		/// Save this <see cref="OPMessage"/> to a file.<br/>
		/// <br/>
		/// Can be loaded at a later time using the <see cref="Load(FileInfo)"/> method.
		/// </summary>
		/// <param name="file">The File location to save the <see cref="OPMessage"/> to. Existent files will be overwritten.</param>
		...
		/// <summary>
		/// Save this <see cref="OPMessage"/> to a stream.<br/>
		/// </summary>
		...
		/// <summary>
		/// Loads a <see cref="OPMessage"/> from a file containing a raw email.
		/// </summary>
		/// <param name="file">The File location to load the <see cref="OPMessage"/> from. The file must exist.</param>
		/// <exception cref="ArgumentNullException">If <paramref name="file"/> is <see langword="null"/></exception>
		...
		/// <returns>A <see cref="OPMessage"/> with the content loaded from the <paramref name="file"/></returns>
		public static OPMessage Load(FileInfo file)
		{
			if (file == null)
				throw new ArgumentNullException("file");
		...
		/// <summary>
		/// Loads a <see cref="OPMessage"/> from a <see cref="Stream"/> containing a raw email.
		/// </summary>
		/// <param name="messageStream">The <see cref="Stream"/> from which to load the raw <see cref="OPMessage"/></param>
		/// <exception cref="ArgumentNullException">If <paramref name="messageStream"/> is <see langword="null"/></exception>
		/// <exception>Other exceptions relevant to <see cref="Stream.Read"/> might be thrown as well</exception>
		/// <returns>A <see cref="OPMessage"/> with the content loaded from the <paramref name="messageStream"/></returns>
		public static OPMessage Load(Stream messageStream)
		{
			if (messageStream == null)
				throw new ArgumentNullException("messageStream");
