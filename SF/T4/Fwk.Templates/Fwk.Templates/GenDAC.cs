...
namespace Fwk.Guidance.Core
{
    ...
    internal static class GenDAC
    {
        ...
        static GenDAC()
        {
            ...
            _Method_tt = FwkGenerator.TemplateDocument.GetTemplate("Method").Content; 
        ...
        static string Get_Property_Batch(Column c, bool pLastField)
        {
            ...
            {
                case "BIT":
                    str.Append(FwkGenerator.TemplateDocument.GetTemplate("SPParameterBatchBit").Content);
                    break;
                case "REAL":
                case "NUMERIC":
                case "BIGINT":
                ...
                case "INT":
                case "TINYINT":
                    str.Append(FwkGenerator.TemplateDocument.GetTemplate("SPParameterBatchInteger").Content);
                    break;
                case "MONEY":
                case "SMALLMONEY":
                case "DECIMAL":
                case "FLOAT":
                    str.Append(FwkGenerator.TemplateDocument.GetTemplate("SPParameterBatchDecimal").Content);
                    break;
                case "SMALLDATETIME":
                case "DATETIME":
                    str.Append(FwkGenerator.TemplateDocument.GetTemplate("SPParameterBatchDateTime").Content);
                    break;
                case "TEXT":
                case "NTEXT":
                case "CHAR":
                ...
                case "VARCHAR":
                case "NVARCHAR":
                    str.Append(FwkGenerator.TemplateDocument.GetTemplate("SPParameterBatchString").Content);
                    break;
            ...
            {
                if (FwkGenerator.GetCSharpType(c).Contains("string"))
                    str.Replace("[Batch_NULL_Question_string]", FwkGenerator.TemplateDocument.GetTemplate("Batch_NULL_Question").Content);
                else
                    str.Replace("[Batch_NULL_Question]", FwkGenerator.TemplateDocument.GetTemplate("Batch_NULL_Question").Content);
            }
