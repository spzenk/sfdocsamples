...
namespace pelsoft.FWK_Dsl
{
	...
	public partial class ModelRootSerializer
	{
				...
				if (schemaResolver != null)
				{
					...
					if (!string.IsNullOrEmpty(targetNamespace))
					{
						...
						if (schemas != null && schemas.Count > 0)
						{
							if (schemas.Count > 1)
							{
								FWK_DslSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
							}
							...
							FWK_DslSerializationBehaviorSchemaValidationCallback validationCallback = new FWK_DslSerializationBehaviorSchemaValidationCallback(serializationContext);
						...
						{
							FWK_DslSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
						}
					}
				}
		...
		private static void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						FWK_DslSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					FWK_DslSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		/// </summary>
		private sealed class FWK_DslSerializationBehaviorSchemaValidationCallback
		{
			...
			internal FWK_DslSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					FWK_DslSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/FWK_Dsl";
...
{
	/// <summary>
	/// Helper class for serializing and deserializing FWK_Dsl models.
	/// </summary>
	public abstract partial class FWK_DslSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected FWK_DslSerializationHelperBase() { }
		#endregion
		...
		public virtual ModelRoot LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			...
			{
				throw new global::System.InvalidOperationException(FWK_DslDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			...
			if (modelRootSerializer != null)
			{
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true))
					{
						...
						// Set up MonikerResolver for FWK_Dsl.
		...
		public virtual string GetSerializedModelString(global::pelsoft.FWK_Dsl.ModelRoot modelRoot, global::System.Text.Encoding encoding)
		{
		...
		/// <summary>
		/// DomainXmlSerializerDirectory instance used by this FWK_DslSerializationHelper class.
		/// </summary>
		...
		protected virtual DslModeling::DomainXmlSerializerDirectory Directory
		{
			...
			get
			{
				if (this.directory == null)
				{
					...
					directory.AddBehavior(FWK_DslSerializationBehavior.Instance);
				}
		...
		internal protected virtual global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> GetMonikerResolvers(DslModeling::Store store)
		{
			...
			result.Add(FWK_DslDomainModel.DomainModelId, new FWK_DslSerializationBehaviorMonikerResolver(store, this.Directory));
			return result;
		}
	...
	/// Helper class for serializing and deserializing FWK_Dsl models.
	/// </summary>
	public sealed partial class FWK_DslSerializationHelper : FWK_DslSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private FWK_DslSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static FWK_DslSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static FWK_DslSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (FWK_DslSerializationHelper.instance == null)
					FWK_DslSerializationHelper.instance = new FWK_DslSerializationHelper();
				return FWK_DslSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace pelsoft.FWK_Dsl
{
	...
	public partial class ModelRoot
	{
		...
		{
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = FWK_DslSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									FWK_DslDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
