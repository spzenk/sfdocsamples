...
namespace pelsoft.FWK_Dsl
{
	...
	/// </remarks>
	public partial class FWK_DslHelpKeywordHelper : FWK_DslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new FWK_DslHelpKeywordHelper.
		/// </summary>
		protected FWK_DslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the FWK_DslHelpKeywordHelper.
		/// </summary>
		public static FWK_DslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class FWK_DslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new FWK_DslHelpKeywordHelperBase.
		/// </summary>
		protected FWK_DslHelpKeywordHelperBase()
			: base() { }
