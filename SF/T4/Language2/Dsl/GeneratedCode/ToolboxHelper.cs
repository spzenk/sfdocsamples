...
namespace pelsoft.FWK_Dsl
{
	...
	/// </remarks>
	public partial class FWK_DslToolboxHelper : FWK_DslToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new FWK_DslToolboxHelper.
		/// </summary>
		public FWK_DslToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	/// Helper class used to create and initialize toolbox items for this DSL.
	/// </summary>
	public abstract class FWK_DslToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify FWK_Dsl toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "FWK_Dsl.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new FWK_DslToolboxHelperBase.
		/// </summary>
		protected FWK_DslToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::pelsoft.FWK_Dsl.FWK_DslDomainModel.SingletonResourceManager.GetString("Class DiagramsToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
