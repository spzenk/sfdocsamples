...
namespace pelsoft.FWK_Dsl.DslPackage
{
	...
	/// </summary>
	internal partial class FWK_DslDocData : FWK_DslDocDataBase
	{
		/// <summary>
		/// Constructs a new FWK_DslDocData.
		/// </summary>
		public FWK_DslDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a FWK_Dsl document in memory.
	/// </summary>
	internal abstract class FWK_DslDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new FWK_DslDocDataBase.
		/// </summary>
		protected FWK_DslDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
                return global::pelsoft.FWK_Dsl.FWK_DslDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::pelsoft.FWK_Dsl.FWK_DslSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
