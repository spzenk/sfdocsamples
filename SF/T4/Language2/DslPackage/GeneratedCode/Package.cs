...
namespace pelsoft.FWK_Dsl.DslPackage
{
	...
	[VSShell::ProvideToolWindow(typeof(FWK_DslExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(FWK_DslExplorerToolWindow), Constants.FWK_DslEditorFactoryId)]
	[VSShell::ProvideEditorFactory(typeof(FWK_DslEditorFactory), 103, TrustLevel = VSShellInterop::__VSEDITORTRUSTLEVEL.ETL_AlwaysTrusted)]
	[VSShell::ProvideEditorExtension(typeof(FWK_DslEditorFactory), "." + Constants.DesignerFileExtension, 32)]
	...
	internal abstract partial class FWK_DslPackageBase : DslShell::ModelingPackage
	{
		/// <summary>
...
namespace pelsoft.FWK_Dsl.DslPackage
{
	...
	[VSTextTemplatingHost::ProvideDirectiveProcessor(typeof(global::pelsoft.FWK_Dsl.FWK_DslDirectiveProcessor), global::pelsoft.FWK_Dsl.FWK_DslDirectiveProcessor.FWK_DslDirectiveProcessorName, "A directive processor that provides access to FWK_Dsl files")]
	[global::System.Runtime.InteropServices.Guid(Constants.FWK_DslPackageId)]
	internal sealed partial class FWK_DslPackage : FWK_DslPackageBase
	{
	}
}