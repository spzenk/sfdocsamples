...
namespace pelsoft.FWK_Dsl.DslPackage
{
	...
	/// </summary>
	internal partial class FWK_DslDocView : FWK_DslDocViewBase
	{
		/// <summary>
		/// Constructs a new FWK_DslDocView.
		/// </summary>
		public FWK_DslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class FWK_DslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new FWK_DslDocView.
		/// </summary>
		protected FWK_DslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::pelsoft.FWK_Dsl.ClassDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::pelsoft.FWK_Dsl.ClassDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::pelsoft.FWK_Dsl.FWK_DslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::pelsoft.FWK_Dsl.FWK_DslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.FWK_DslDiagramMenu;
			}
		}
			...
			if(global::pelsoft.FWK_Dsl.FWK_DslHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::pelsoft.FWK_Dsl.FWK_DslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
