...
namespace pelsoft.FWK_Dsl.DslPackage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.FWK_DslEditorFactoryId)]
	internal partial class FWK_DslEditorFactory : FWK_DslEditorFactoryBase
	{
		/// <summary>
	...
	/// </summary>
	internal abstract class FWK_DslEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		...
		protected override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new FWK_DslDocData(this.ServiceProvider, typeof(FWK_DslEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new FWK_DslDocView(docData, this.ServiceProvider);
		}
	}
}
