...
using CustomSecurity.Common.Api.HttpFetchers;
using CustomSecurity.Common.Api.TypeMappers;
using CustomSecurity.Common;
using CustomSecurity.Common.Security;
using NHibernate;
...
namespace CustomSecurity.Web
{
    ...
    public class NinjectConfigurator
    {
        ...
        private void ConfigureNHibernate(IKernel container)
        {
            ...
            //var sessionFactory2 = FluentNHibernate.Cfg.Fluently.Configure()
            //.Database(
