...
public partial class GridViewEditCell2 : System.Web.UI.Page
{
    /// <summary>
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            case ("SingleClick"):
                ...
                if (_gridView.Rows[_rowIndex].Cells[_columnIndex].Controls.Count > 5)
                {
                    Control _validatorControl = _gridView.Rows[_rowIndex].Cells[_columnIndex].Controls[5];
