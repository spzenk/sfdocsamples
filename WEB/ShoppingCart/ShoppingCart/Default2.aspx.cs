...
namespace WebApplication1
{
    public partial class Default2 : System.Web.UI.Page
    {
        ...
        private void FillCat(int? idSubcategoria)
        {
            ...
            TreeViewBind(this.trvCategories, categories);
        ...
        /// data source.
        /// </summary>
        private void TreeViewBind(TreeView trv, ProductCategotyBEList categories)
        {
            try
            {
        ...
        private void AddSubcategories(TreeNode parent, string parentId, ProductCategotyBEList categories)
        {
            ...
            foreach (ProductCategotyBE childCatatBE in childsBE)
            {
                ...
                if (childCatatBE.Level == 3)
                    nodeTree_Child.NavigateUrl = string.Concat("Default2.aspx?id=" + childCatatBE.Id );
                else
