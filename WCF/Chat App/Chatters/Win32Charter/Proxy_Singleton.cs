...
namespace WPFChatter
{
    ...
    public sealed class Proxy_Singleton : IChatCallback
    {
        ...
        public IAsyncResult BeginReceive(Person sender, string message, AsyncCallback callback, object asyncState)
        {
        ...
        public IAsyncResult BeginReceiveWhisper(Person sender, string message, AsyncCallback callback, object asyncState)
        {
            throw new Exception("The method or operation is not implemented.");
        }
        ...
        public IAsyncResult BeginUserEnter(Person person, AsyncCallback callback, object asyncState)
        {
            throw new Exception("The method or operation is not implemented.");
        }
        ...
        public IAsyncResult BeginUserLeave(Person person, AsyncCallback callback, object asyncState)
        {
            throw new Exception("The method or operation is not implemented.");
        }
